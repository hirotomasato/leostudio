...
const zh: Record<string, string> = {
  ...
  "Compose": "创作", "Compose image": "创作图片", "Compose video": "创作视频", "Prompt": "提示词", "Model": "模型", "Aspect ratio": "宽高比", "Quantity": "数量", "Reference": "参考图", "Result": "结果", "Generate": "生成", "Generating...": "正在生成...", "Ready to generate": "准备生成", "Generated images appear here.": "生成的图片将显示在这里。", "Generated video appears here.": "生成的视频将显示在这里。", "Generated image": "生成的图片", "No model": "没有模型", "default": "默认", "Preview": "预览", "Preview image": "预览图片", "Open fullscreen preview": "打开全屏预览", "Open": "打开", "Rendering {duration}s clip": "正在渲染 {duration} 秒视频", "Resolution": "分辨率", "Duration": "时长", "Native audio": "原生音频", "Start frame": "起始帧", "optional": "可选", "No video model registered": "尚未注册视频模型", "Video model catalog is empty. Add a model in {path}.": "视频模型目录为空。请在 {path} 中添加模型。", "{count} image · cookie #{id}": "{count} 张图片 · Cookie #{id}", "{count} video · cookie #{id}": "{count} 个视频 · Cookie #{id}",
  ...
  "Image": "图片", "Video": "视频", "Sync": "同步", "Name": "名称", "Model UUID": "模型 UUID", "Default": "默认", "Default · {name}": "默认 · {name}", "No image models": "没有图片模型", "Sync from Leonardo": "从 Leonardo 同步", "audio": "音频", "ref image": "参考图", "Model UUID required": "需要模型 UUID", "Model added": "模型已添加", "Synced · {total} models (+{added} new, {updated} updated)": "已同步 · {total} 个模型（新增 {added}，更新 {updated}）", "Delete model {name}?": "删除模型“{name}”？",
  "All": "全部", "Search prompt, model, gen id…": "搜索提示词、模型或生成 ID…", "Use prompt": "使用提示词", "Prompt loaded into {target}": "提示词已载入{target}", "Pause": "暂停", "Play": "播放", "Open fullscreen": "打开全屏", "No results": "没有结果", "Try changing the filter or clearing the search box.": "请更改筛选条件或清除搜索框。",
